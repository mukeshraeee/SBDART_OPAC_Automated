...
c                           sc(1)=wind speed in meters/second
c                           sc(2)=wind direction azimuth angle (degrees)
c                           sc(3)=Oceanic pigment concentration in mg/m3
...
c
     ...
     &     rliso,rlvol,rlgeo,rlhot,rlwdth
      ...
      case (7)                ! ocean reflectance model
        ibdrf=1
        nna=0
        chlor=sc(1)
        wndspd=sc(2)
      ...
      case (9)                ! ross-thick, li-sparse bdrf model
        ibdrf=3
        nna=0
        rliso=sc(1)
        rlvol=sc(2)
...
c     .. Scalar Arguments ..
      ...
      use albblk, only: ibdrf, brlim,mxbc
      use params, only: kr
      ...
      jj=min(1+int(100*mui),100)
c      blim=............... (weighted average of brlim at mui)
...
c   bdref surface reflectance
     ...
     &     rfco=0.22       ! average albedo of foam +- 0.11 (koepke)
      ...
      call sunglint(wndspd,nr,ni,wndang,mus,muv,phir,rgl)
...
c
       ...
       real(kr) ::  twl(62),tnr(62),tni(62),nr,ni,wl,xwl,
     &      yr,yi,nrc,nic,xsal
       integer :: i
...
c
c=======================================================================
      subroutine sunglint(wndspd,nr,ni,wndang,csin,cvin,phi,rog)
...
c                     wndang=azim. of the sun - azim. of the wind (in deg.)
...
c
      ...
      real(kr), intent(in) :: wndspd,nr,ni,wndang,csin,cvin,phi
...
c
      ...
      read(13,*,end=20) (wl(i),r(i),i=1,huge(0))
 20   continue
      close(unit=13)
